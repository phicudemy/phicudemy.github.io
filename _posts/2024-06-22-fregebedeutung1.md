...
اوضاع وخیم‌تر می‌شود وقتی توجه می‌کنیم که فرگه تمایزِ فوق را نه تنها برای الفاظِ مفرد، بلکه برای تقریباً همه‌ی عباراتِ معنادارِ زبان معرفی می‌کند. مشخصاً، او قائل است Bedeutung جملاتِ معنادارِ زبان ارزشِ صدق‌ آن‌ها است. بنابراین، تمامِ جملاتِ صادق Bedeutung واحدی دارند که صدق (the True) است و همه‌ی جملاتِ کاذب هم Bedeutung واحدی دارند که کذب (the False) است. در اینجا هم، باز با صرف‌نظر از جزئیات، می‌بینیم که برگرداندنِ ‘Bedeutung’ به ‘meaning’ («معنا») به نتایجی نامقبول می‌انجامد. برای مثال، اگر چنین معادلی برگزینیم، باید بگوییم هر دو جمله‌ی صادقی در زبان، مثلاً دو جمله‌ی «نویسنده‌ی گلستان شیرازی است» و «دو به علاوه دو می‌شود چهار»، هم‌معنا/مترادف اند (و هکذا هر دو جمله‌ی کاذبی در زبان)، چیزی که به‌وضوح مهمل به نظر می‌رسد.[\[۱۱\]](#fn-11){:.fnref #fnref-11}

**<center>(II)</center>**

با این ملاحظات، اکنون می‌توانیم بفهمیم چرا، تقریباً، هیچ کدام از مترجمانِ فرگه، شارحانِ او، یا دیگر فیلسوفانی که تا پیش از انتشارِ ترجمه‌ی لانگ و وایت از _نوشته‌ها_ در زبانِ انگلیسی به آثار فرگه پرداخته‌اند ‘Bedeutung’ را در آثارِ متأخرِ فرگه به ‘meaning’ برنگرداند.[\[۱۲\]](#fn-12){:.fnref #fnref-12} نخستین بحث از تمایزِ فرگه میانِ Sinn و Bedeutung در زبان انگلیسی را راسل، در ضمیمه‌ی معروفِ خود بر *اصولِ ریاضیات* (۱۹۰۳)، منتشر کرده است. او در این جا از ‘indication’ به‌عنوانِ معادل برای Bedeutung استفاده می‌کند.[\[۱۳\]](#fn-13){:.fnref #fnref-13} یوردان در ترجمه‌ی خود، با همکاری استچلراث، از حدودِ سی‌صفحه‌ی نخستِ _اصول پایه‌ای حسابِ_ فرگه (۱۸۹۳)،[\[۱۴\]](#fn-14){:.fnref #fnref-14} آن را به ‘denotation’ بر‌گرداند، انتخابی که فورث هم در ترجمه‌ی بخش‌های بیشتری از این اثر در ۱۹۶۴ از آن تبعیت می‌کند.[\[۱۵\]](#fn-15){:.fnref #fnref-15} در تفسیرِ کارنپ از چیستی رابطه‌ی Bedeutung نزد فرگه، در کتابِ _معنا و ضرورت_ (۱۹۴۸)، این رابطه اساساً از جنسِ رابطه‌ی نامیدن (naming) است. لذا او اصطلاحِ فنیِ ‘nominatum’ را به‌عنوانِ معادلِ ‘Bedeutung’ معرفی می‌کند.
