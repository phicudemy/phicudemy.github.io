...
گفته‌ی فوق از پیتر لانگ و راجر وایت، مترجمانِ کتابِ _نوشته‌های پس از مرگ‌ منتشرشده‌‌_ی ریاضیدان و فیلسوف آلمانی  گوتلب فرگه (۱۹۲۵-۱۸۴۸) (از این پس_،_ _نوشته‌ها_) بیان‌گرِ‌شرطِ کفایتی به‌نظر مناقشه‌ناپذیر است برای هر ترجمه‌ی فلسفی مقبول. این اصل، که ایشان از آن با عنوانِ «بی‌طرفیِ فلسفی» یاد می‌کنند، بیانی است از این ایده‌ی کلّی که مترجمِ اثری فلسفی شارح آن نیست. او، در مقامِ مترجم، نباید به حل‌وفصل مناقشاتِ تفسیری برخاسته از متن، از راهِ برگزیدنِ معادل‌هایی خاص برای عبارات یا جملاتِ اثرِ اصلی، بپردازد.
