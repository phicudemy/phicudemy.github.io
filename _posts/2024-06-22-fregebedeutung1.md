...
بنابراین، به‌طور خلاصه، تا پیش از انتشار *نوشته‌ه*ا، ازیک‌سو، در بعدِ سلبی، اجماع تقریباً کاملی بوده است که «meaning» معادل مناسبی در زبان انگلیسی برای «Bedeutung» در آثار متأخر فرگه نیست. ازسوی‌دیگر، در بعد ایجابی، «reference»، به‌خصوص در مکتوبات ثانویه راجع به فرگه، برای این منظور جا افتاده بوده است. 
